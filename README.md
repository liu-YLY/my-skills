...
|---|---|---|---|
| **testing-bundle** | v3.2.0 | bundle 入口，6-way 路由（5 核心 + 1 协同）+ 7 条混合意图链 | - |
...
| bug-analyzer | v1.1.0 | Bug 根因分析（五步定位法/鱼骨图/5 Whys） | - |
...
| performance-test-engineer | 232 | 5 |
| state-machine-test-engineer | 270 | 12 |
