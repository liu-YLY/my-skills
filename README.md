...
│   │
│   ├── test-case-engineer/        # 测试用例工程师技能 v8.0.0
│   │   ├── SKILL.md               # 技能入口索引
│   │   ├── test-case-engineer-core.md  # 核心流程文档
│   │   ├── README.md              # 技能说明文档
│   │   ├── knowledge/             # 知识库
...
│   │       └── user-guide.md     # 用户指南
│   │
│   ├── bug-analyzer/              # Bug 分析师技能 v1.0.0
│   │   ├── SKILL.md               # 技能入口 + 核心流程（五步定位法）
│   │   ├── README.md              # 技能说明文档
│   │   ├── knowledge/             # 知识库
│   │   │   ├── root-cause-frameworks.md # 鱼骨图/5 Whys/因果链
│   │   │   └── bug-patterns-index.md    # 指向 test-case-engineer 共享缺陷模式库
│   │   ├── integrations/
│   │   │   └── quickstart.md     # 本地操作速查
│   │   └── scripts/
│   │       ├── convert_docs.py   # 文档转换
...
2. **安装依赖**（可选，用于工具脚本）
   ```bash
   cd skills/test-case-engineer/scripts
