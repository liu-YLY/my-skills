...
6. state-machine-test-engineer 可选安装配套 MCP Server 进入增强模式（v0.3.0 协议层 stdio + HTTP 已端到端联调验证，安装后增强模式可用；详见 [state-machine-test-engineer/integrations/quickstart.md](../../state-machine-test-engineer/integrations/quickstart.md)）
